...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // method_definition
      char dummy5[sizeof (std::shared_ptr<FunctionNode>)];
      ...
      // call
      // variable
      char dummy6[sizeof (std::shared_ptr<Node>)];
      ...
      // methods
      char dummy8[sizeof (std::vector<std::shared_ptr<FunctionNode>>)];
      ...
      // expressions
      // for_start
      char dummy9[sizeof (std::vector<std::shared_ptr<Node>>)];
